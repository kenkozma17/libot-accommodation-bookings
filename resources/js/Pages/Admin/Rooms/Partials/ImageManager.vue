<script setup>
  ...
  const removeImage = (imageId) => {
    imageForm.delete(route('rooms.delete-image', imageId), {
      ...
      preserveScroll: true,
      onSuccess: () => {
        const imageIndex = form.images.findIndex(image => image.id === imageId);
        ...
        <div 
          ...
          <div 
            ...
            <div
              ...
              <svg class="hover:bg-gray-300 h-5 w-5 text-black border-black border rounded bg-white" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
