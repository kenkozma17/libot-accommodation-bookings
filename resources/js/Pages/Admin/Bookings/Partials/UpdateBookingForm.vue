...
const form = useForm({
  ...
  total_price: props.booking.payment
    ? props.booking.payment.payment_amount_formatted
    : "PHP " + props.booking.total_price,
    ...
    <template #form>
      ...
      <div class="col-span-6 sm:col-span-4">
        ...
        <TextInput
          ...
          autofocus
        />
        <InputError :message="form.errors.booking_status" class="mt-2" />
      </div>
