                ...
                <Dropdown align="left" width="60">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <DropdownLink :href="route('guests.index')">
                        Guests List
                      </DropdownLink>
                      <DropdownLink :href="route('guests.create')">
                        Create Guest
                      </DropdownLink>
                    </div>
                  </template>
                ...
                <Dropdown align="left" width="60">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <DropdownLink :href="route('rooms.create')">
                        Create Room
                      </DropdownLink>
                    </div>
                  </template>
                ...
                <Dropdown align="left" width="60">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <DropdownLink :href="route('folios.index')">
                        Folios List
                      </DropdownLink>
                      <DropdownLink :href="route('folios.create')">
                        Create Folio
                      </DropdownLink>
                    </div>
                  </template>
                ...
                <Dropdown align="left" width="60">
                  ...
                  <template #content>
                    <div class="w-60">
                      ...
                      <DropdownLink :href="route('services.create')">
                        Create Service
                      </DropdownLink>
                    </div>
                  </template>
                ...
                <Dropdown align="left" width="60">
                    ...
                    <template #content>
                      <div class="w-60">
                        ...
                        <DropdownLink :href="route('expenses.index')">
                          Expenses List
                        </DropdownLink>
